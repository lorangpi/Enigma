...
(:predicates
  ...
  (:action a0
    ...
    :precondition (and (b0 ?obj0 ?obj1) (b0 ?obj0 ?obj2) (b0 ?obj1 ?obj2) (b1 ?obj0 ?obj2) (b1 ?obj1 ?obj2) (not (p0 ?obj1)) (not (p0 ?obj2)) (p1 ?obj0 ?obj1) (not (p1 ?obj0 ?obj2)))
    :effect (and 
      (not (p0 ?obj0)) (p0 ?obj1) (p1 ?obj0 ?obj2) (not (p1 ?obj1 ?obj2))
    )
  )
)
