...
reach_pick = Executor_RL(id='ReachPick', 
                         alg=sac.SAC, 
                         policy="/home/lorangpi/Enigma/data/demo_seed_6/2024-04-30_20:43:23_reach_pick/policy/best_model.zip",
                         I={}, 
...
for operator in plan:
    ...
    if 'peg' in obj_mapping[obj_to_pick]:
        pick_loc = area_pos[obj_mapping[obj_to_pick]]
    else:
        pick_loc = env.sim.data.body_xpos[obj_body_mapping[obj_to_pick]][:3]
    if i == 1:
        action_step = Executor_RL(id='ReachDrop', 
                            alg=sac.SAC, 
                            policy="./data/demo_seed_4/2024-04-28_00:01:08_reach_drop/policy/best_model.zip", 
                            I={}, 
                            Beta=termination_indicator('reach_drop'),
        ...
        action_step = Executor_RL(id='ReachPick', 
                            alg=sac.SAC, 
                            policy="/home/lorangpi/Enigma/data/demo_seed_6/2024-04-30_20:43:23_reach_pick/policy/best_model.zip",
                            I={}, 
                            Beta=termination_indicator('reach_pick'),
