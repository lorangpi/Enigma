...
from robosuite.wrappers.hanoi.hanoi_pick_place import PickPlaceWrapper
...
if __name__ == "__main__":
    ...
    # Define the wrapper for the pick and place actions
    place = Executor_Diffusion(id='Place_lxm_baseline', 
                       policy="/home/lorangpi/Enigma/lxm/hanoi_il/2025.03.26/07.45.34_train_diffusion_transformer_lowdim_lxm_obj_hanoi_place/checkpoints/epoch=6800-train_loss=0.004.ckpt", 
                       I={}, 
                       Beta=termination_indicator('drop'),
                       nulified_action_indexes=[],
                       wrapper = HanoiPlaceWrapper,
                       horizon=30)
    pick = Executor_Diffusion(id='Pick_lxm_baseline', 
    ...
    def env_fn():
        ...
        env = object_state_wrapper["Hanoi"](env)
