...
if __name__ == "__main__":
    ...
    reach_drop = Executor_Diffusion(id='ReachDrop', 
                            ...
                            policy="./policies/expert/5x4/latest.ckpt",
                            I={}, 
    ...
    def map_predicate(predicate):
        ...
        obj_mapping = {'cube1': 'o1', 'cube2': 'o2', 'cube3': 'o6', 'cube4': 'o7', 'cube5': 'o9', 'peg0': 'o8', 'peg1': 'o3', 'peg2': 'o4', 'peg3': 'o5'}
    ...
    #     'peg3': peg3_body
    # }
    obj_mapping = {'o1': 'cube1', 'o2': 'cube2', 'o6': 'cube3', 'o7': 'cube4', 'o9': 'cube5', 'o8': 'peg0', 'o3': 'peg1', 'o4': 'peg2', 'o5': 'peg3'}
    ...
    for i in range(100):
        ...
        os.makedirs("results5x4", exist_ok=True)
        with open(f"results5x4/results_neurosym_{args.demos}_seed_{args.seed}.txt", 'w') as file:
