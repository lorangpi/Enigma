...
class SQIL_HER(algo_base.DemonstrationAlgorithm[types.Transitions]):
    ...
    def __init__(
        ...
        *,
        ...
        rl_algo_class: Type[off_policy_algorithm.OffPolicyAlgorithm] = sac.SAC,
        ...
        self.rl_algo = rl_algo_class(
            policy=policy,
            env=venv,
            replay_buffer_class=SQILHERReplayBuffer,
    ...
    def set_demonstrations(self, demonstrations: algo_base.AnyTransitions) -> None:
        assert isinstance(self.rl_algo.replay_buffer, SQILHERReplayBuffer)
...
class SQILHERReplayBuffer(buffers.HerReplayBuffer):
